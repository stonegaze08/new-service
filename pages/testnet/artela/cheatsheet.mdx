...
artelad tx slashing unjail --from wallet --chain-id artela_11822-1 --gas-adjustment 1.5 --gas auto --gas-adjustment 1.5  -y
```
...
artelad tx distribution withdraw-all-rewards --from wallet --chain-id artela_11822-1 --gas-adjustment 1.5 --gas auto --gas-adjustment 1.5  -y
```
```js filename="Withdraw reward and commission"
artelad tx distribution withdraw-rewards $(artelad keys show wallet --bech val -a) --commission --from wallet --chain-id artela_11822-1 --gas-adjustment 1.5 --gas auto --gas-adjustment 1.5  -y
```
```js filename="Delegate tokens to your validator"
artelad tx staking delegate $(artelad keys show wallet --bech val -a) 1000000uart --from wallet --chain-id artela_11822-1 --gas-adjustment 1.5 --gas auto --gas-adjustment 1.5  -y
```
```js filename="Delegate token to other validator, change <to-valoper-address> as you like"
artelad tx staking delegate <to-valoper-address> 1000000uart --from wallet --chain-id artela_11822-1 --gas-adjustment 1.5 --gas auto --gas-adjustment 1.5  -y
```
```js filename="Redelegate to another validator"
artelad tx staking redelegate $(artelad keys show wallet --bech val -a) <to-valoper-address> 1000000uart --from wallet --chain-id artela_11822-1 --gas-adjustment 1.5 --gas auto --gas-adjustment 1.5  -y
```
```js filename="Unbond token from your own validator"
artelad tx staking unbond $(artelad keys show wallet --bech val -a) 1000000uart --from wallet --chain-id artela_11822-1 --gas-adjustment 1.5 --gas auto --gas-adjustment 1.5  -y
```
```js filename="Send token to the wallet"
artelad tx bank send wallet <to-wallet-address> 1000000uart --from wallet --chain-id artela_11822-1 --gas-adjustment 1.5 --gas auto --gas-adjustment 1.5  -y
```
## Governance
...
artelad tx gov vote 1 yes --from wallet --chain-id artela_11822-1 --gas-adjustment 1.5 --gas auto --gas-adjustment 1.5  -y
```
```js filename="Vote option no"
artelad tx gov vote 1 no --from wallet --chain-id artela_11822-1 --gas-adjustment 1.5 --gas auto --gas-adjustment 1.5  -y
```
```js filename="Vote option asbtain"
artelad tx gov vote 1 abstain --from wallet --chain-id artela_11822-1 --gas-adjustment 1.5 --gas auto --gas-adjustment 1.5  -y
```
```js filename="Vote option NoWithVeto"
artelad tx gov vote 1 NoWithVeto --from wallet --chain-id artela_11822-1 --gas-adjustment 1.5 --gas auto --gas-adjustment 1.5  -y
```
...
sed -i -e "s/^minimum-gas-prices *=.*/minimum-gas-prices = \"10mpx\"/" $HOME/.artelad/config/app.toml
```
