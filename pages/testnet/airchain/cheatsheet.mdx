...
junctiond tx slashing unjail --from wallet --chain-id junction --gas-adjustment 1.5 --gas auto --gas-prices 10000000000000mpx -y
```
...
junctiond tx distribution withdraw-all-rewards --from wallet --chain-id junction --gas-adjustment 1.5 --gas auto --gas-prices 10000000000000mpx -y
```
```js filename="Withdraw reward and commission"
junctiond tx distribution withdraw-rewards $(junctiond keys show wallet --bech val -a) --commission --from wallet --chain-id junction --gas-adjustment 1.5 --gas auto --gas-prices 10000000000000mpx -y
```
```js filename="Delegate tokens to your validator"
junctiond tx staking delegate $(junctiond keys show wallet --bech val -a) 1000000000000000000mpx --from wallet --chain-id junction --gas-adjustment 1.5 --gas auto --gas-prices 10000000000000mpx -y
```
```js filename="Delegate token to other validator, change <to-valoper-address> as you like"
junctiond tx staking delegate <to-valoper-address> 1000000000000000000mpx --from wallet --chain-id junction --gas-adjustment 1.5 --gas auto --gas-prices 10000000000000mpx -y
```
```js filename="Redelegate to another validator"
junctiond tx staking redelegate $(junctiond keys show wallet --bech val -a) <to-valoper-address> 1000000000000000000mpx --from wallet --chain-id junction --gas-adjustment 1.5 --gas auto --gas-prices 10000000000000mpx -y
```
```js filename="Unbond token from your own validator"
junctiond tx staking unbond $(junctiond keys show wallet --bech val -a) 1000000000000000000mpx --from wallet --chain-id junction --gas-adjustment 1.5 --gas auto --gas-prices 10000000000000mpx -y
```
```js filename="Send token to the wallet"
junctiond tx bank send wallet <to-wallet-address> 1000000000000000000mpx --from wallet --chain-id junction --gas-adjustment 1.5 --gas auto --gas-prices 10000000000000mpx -y
```
## Governance
...
junctiond tx gov vote 1 yes --from wallet --chain-id junction --gas-adjustment 1.5 --gas auto --gas-prices 10000000000000mpx -y
```
```js filename="Vote option no"
junctiond tx gov vote 1 no --from wallet --chain-id junction --gas-adjustment 1.5 --gas auto --gas-prices 10000000000000mpx -y
```
```js filename="Vote option asbtain"
junctiond tx gov vote 1 abstain --from wallet --chain-id junction --gas-adjustment 1.5 --gas auto --gas-prices 10000000000000mpx -y
```
```js filename="Vote option NoWithVeto"
junctiond tx gov vote 1 NoWithVeto --from wallet --chain-id junction --gas-adjustment 1.5 --gas auto --gas-prices 10000000000000mpx -y
```
