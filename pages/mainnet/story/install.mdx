...
## <span style={{ fontSize: '20px', color: 'white' }}>View your validator key:</span>
```js filename="View your validator key"
story validator export
```
## <span style={{ fontSize: '20px', color: 'white' }}>View EVM private key and make a key backup</span>
...
```
## <span style={{ fontSize: '20px', color: 'white' }}>Create validator</span>
...
```
## <span style={{ fontSize: '20px', color: 'white' }}>Remember to backup your validator priv_key from here:</span>
